...
- [x] ~~Organizar la web como proyecto aislado en `/web`.~~
- [x] ~~Crear base Astro con scripts de desarrollo, build y preview.~~
...
- [ ] Configurar dominio final y metadatos sociales definitivos.
