...
export const copy: Record<Language, Copy> = {
  en: {
    ...
    trustLine: 'The code is public on GitHub and the download always points to the latest release, so the app and its changes can be reviewed before installing.',
  ...
  es: {
    ...
    trustLine: 'El código es público en GitHub y la descarga apunta siempre a la última release, para poder revisar la app y sus cambios antes de instalar.',
  ...
  ca: {
    ...
    trustLine: 'El codi és públic a GitHub i la descàrrega apunta sempre a l’última release, perquè es pugui revisar l’app i els canvis abans d’instal·lar.',
  ...
  fr: {
    ...
    trustLine: 'Le code est public sur GitHub et le téléchargement pointe toujours vers la dernière release, pour vérifier l’app et ses changements avant installation.',
  ...
  de: {
    ...
    trustLine: 'Der Code ist auf GitHub öffentlich und der Download verweist immer auf das neueste Release, damit App und Änderungen vor der Installation geprüft werden können.',
