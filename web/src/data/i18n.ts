...
export const copy: Record<Language, Copy> = {
  en: {
    ...
    trustLine: 'Settle uses native macOS permissions, keeps layouts on your Mac, and makes the code available for review.',
  ...
  es: {
    ...
    trustLine: 'Settle usa permisos nativos de macOS, guarda los layouts en tu Mac y mantiene el código disponible para revisión.',
  ...
  ca: {
    ...
    trustLine: 'Settle usa permisos natius de macOS, desa els layouts al Mac i manté el codi disponible per revisar-lo.',
  ...
  fr: {
    ...
    trustLine: 'Settle utilise les permissions natives de macOS, garde les agencements sur votre Mac et rend le code disponible à la vérification.',
  ...
  de: {
    ...
    trustLine: 'Settle nutzt native macOS-Berechtigungen, speichert Layouts auf deinem Mac und stellt den Code zur Prüfung bereit.',
