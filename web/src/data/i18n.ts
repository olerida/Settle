...
export const copy: Record<Language, Copy> = {
  en: {
    ...
    downloadMeta:
      "Version 1.3.0 · universal DMG for Apple silicon and Intel · about 1.3 MB",
    trustLine:
    ...
    requirementSize: "DMG: about 1.3 MB",
  ...
  es: {
    ...
    downloadMeta:
      "Versión 1.3.0 · DMG universal para Apple silicon e Intel · alrededor de 1,3 MB",
    trustLine:
    ...
    requirementSize: "DMG: alrededor de 1,3 MB",
  ...
  ca: {
    ...
    downloadMeta:
      "Versió 1.3.0 · DMG universal per a Apple silicon i Intel · prop d’1,3 MB",
    trustLine:
    ...
    requirementSize: "DMG: prop d’1,3 MB",
  ...
  fr: {
    ...
    downloadMeta:
      "Version 1.3.0 · DMG universel Apple silicon et Intel · environ 1,3 Mo",
    trustLine:
  ...
  de: {
    ...
    downloadMeta:
      "Version 1.3.0 · universelles DMG für Apple Silicon und Intel · etwa 1,3 MB",
    trustLine:
    ...
    requirementSize: "DMG: etwa 1,3 MB",
